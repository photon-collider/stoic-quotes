defmodule StoicQuotesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StoicQuotesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StoicQuotesWeb.Gettext, "errors", msg, opts)
    end
  end
