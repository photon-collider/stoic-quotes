...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/stoic_quotes ./

COPY ./entrypoint.sh ./entrypoint.sh
RUN chmod a+x ./entrypoint.sh

RUN mkdir -p priv/repo
COPY ./priv/repo/quotes.json ./priv/repo/quotes.json
COPY ./priv/repo/seeds.exs ./priv/repo/seeds.exs
